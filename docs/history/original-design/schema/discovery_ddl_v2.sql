...
DROP TRIGGER IF EXISTS validate_event_log_chain;
...
DROP TABLE IF EXISTS defeater_evidence;
DROP TABLE IF EXISTS defeater;
DROP TABLE IF EXISTS adversarial_check;
DROP TABLE IF EXISTS experiment_artifact;
DROP TABLE IF EXISTS proof_obligation_experiment;
DROP TABLE IF EXISTS proof_obligation_evidence;
