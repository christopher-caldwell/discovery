...
DROP TRIGGER IF EXISTS prevent_artifact_update;
DROP TRIGGER IF EXISTS prevent_artifact_delete;
DROP TRIGGER IF EXISTS prevent_research_activity_update;
DROP TRIGGER IF EXISTS prevent_research_activity_delete;

DROP TABLE IF EXISTS assurance_score;
DROP TABLE IF EXISTS technical_spec_revision;
DROP TABLE IF EXISTS defeater_decision;
DROP TABLE IF EXISTS defeater_claim;
DROP TABLE IF EXISTS defeater;
DROP TABLE IF EXISTS experiment_artifact;
DROP TABLE IF EXISTS proof_obligation_experiment;
DROP TABLE IF EXISTS experiment;
DROP TABLE IF EXISTS proof_obligation;
DROP TABLE IF EXISTS technical_decision_claim;
DROP TABLE IF EXISTS technical_decision;
DROP TABLE IF EXISTS implementation_strategy;
DROP TABLE IF EXISTS agent_claim_position;
DROP TABLE IF EXISTS argument_evidence;
...
DROP TABLE IF EXISTS research_method;
DROP TABLE IF EXISTS research_surface;
DROP TABLE IF EXISTS research_lane_dependency;
DROP TABLE IF EXISTS research_lane_need;
DROP TABLE IF EXISTS research_lane;
DROP TABLE IF EXISTS research_need;
DROP TABLE IF EXISTS assumption;
DROP TABLE IF EXISTS question_respondent;
DROP TABLE IF EXISTS clarification_question;
DROP TABLE IF EXISTS phase_revision;
DROP TABLE IF EXISTS discovery_run;
...
CREATE TABLE source_repository (
    ...
    , CONSTRAINT chk_source_repository_drift_status             CHECK (drift_status IN ('current', 'drifted', 'refreshed'))
...
CREATE TABLE research_activity (
    ...
    , generated_lead_count                                      INTEGER                                         NOT NULL DEFAULT 0
    , CONSTRAINT chk_research_activity_lead_count               CHECK (generated_lead_count >= 0)
...
CREATE TABLE agent_run (
    ...
    , CONSTRAINT chk_agent_run_context_sha256                   CHECK (context_sha256 IS NULL OR (length(context_sha256) = 64 AND context_sha256 NOT GLOB '*[^0-9a-f]*'))
...
CREATE TABLE defeater (
    ...
    , CONSTRAINT chk_defeater_status                            CHECK (defeater_status IN ('open', 'defeated', 'confirmed', 'inconclusive', 'superseded'))
