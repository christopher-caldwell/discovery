...
“Update Discovery” refreshes the shared uv tool and this Codex skill. If the user
says “update Discovery for every installed host,” also refresh matching Claude Code
